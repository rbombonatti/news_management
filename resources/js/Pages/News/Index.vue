                        ...
                        <div class="space-y-4">
                            <div class="flex px-4 py-6 border border-gray-200" v-for="news in newsList.data">
                                ...
                                <div class="md:w-1/4">
                                    ...
                                    <Link :href="route(`${routeName}.edit`, {news})" class="edit-button hover:bg-blue-700">Editar</Link>
                                    <Link :href="route(`${routeName}.show`, {news})" class="edit-button hover:bg-blue-700 ml-2">Detalhes</Link>
                                </div>
                            </div>
                        </div>
